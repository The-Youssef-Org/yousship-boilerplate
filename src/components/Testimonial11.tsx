...
const items: T[] = Array.from({ length: 11 }).map((_, i) => ({
  quote: [
    "Best $99 I've ever spent on a side project.",
    "From idea to paying users in 4 days.",
    "Auth + Stripe + emails — done in an afternoon.",
    "Zero boilerplate fatigue, finally.",
    "Looks like a million bucks out of the box.",
    "Ship velocity unlocked.",
    "Cleaned up my stack and my schedule.",
    "Bought it Friday, launched Monday.",
    "The blog setup alone saved me a week.",
    "Documentation is shockingly good.",
    "Now I actually finish projects.",
  ][i],
  name: [
    "Alex M.",
    "Sara C.",
